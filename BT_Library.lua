-- FULL OF PAIN TO CHANGE THE COLOR OF THIS SHIT --
local Blacklib = {}
...
_G.Colors = Color3.fromRGB(0, 255, 255)

local BT_Close = game:GetService("CoreGui").FindFirstChild("BlackTrap-88249245")
...
function Blacklib:Window(text, tweentitle, tvalue)
    _G.TweenTitle2 = tvalue or false
    local osfunc = {}
    local titlefunc = {}
    local pingfunc = {}
    local timefunc = {}
    ...
    BlackTrap.Name = "BlackTrap-88249245" -- To detect as new screen gui not "BlackTrap".
    ...
    BlackImage.Image = "rbxassetid://7251993295"
    BlackImage.ImageColor3 = _G.Colors
    ...
    BlackTitle.Text = ""
    BlackTitle.TextColor3 = _G.Colors
    ...
    ServerTime.TextColor3 = _G.Colors
    ...
    CloseButton.TextColor3 = _G.Colors
    CloseButton.Text = "×"
    ...
    LineWindow.BackgroundColor3 = _G.Colors
    ...
    SpaceWindow.BackgroundColor3 = _G.Colors
    ...
    function TweenTitle(v)
      titlefunc:Refresh(v) wait(.2)
    end

    spawn(function()
        while task.wait() do
            if _G.TweenTitle2 then
              TweenTitle(tweentitle)
              TweenTitle(" ")
            end
        end
    end)
    ...
    function Blacklib:Notification(titledesc, textdesc)
        ...
        NotifHolderUIStroke.Color = _G.Colors
        ...
        OkayBtn.BackgroundColor3 = _G.WindowBackgroundColor
        ...
        OkayBtnTitle.TextColor3 = _G.Colors
        ...
        NotificationTitle.TextColor3 = _G.Colors
        NotificationTitle.TextSize = 20.000
        
        Line.Name = "Line"
        Line.Parent = NotificationFrame
        Line.BackgroundColor3 = _G.Colors
        ...
        NotificationDesc.TextColor3 = _G.Colors
    ...
    function Tabs:Tab(tabtitle, img)
        ...
        TabImage.Image = img or "rbxassetid://7251993295"
        TabImage.ImageColor3 = _G.Colors
        ...
        function Section:NewSection(seclabel)
            ...
            function ItemHand:Button(buttontitle, callback)
                ...
                Button.TextColor3 = _G.Colors
                Button.TextSize = 12.000
                
                UIStroke.Name = "UIStroke"
                UIStroke.Parent = Button
                UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                UIStroke.Color = _G.Colors
            ...
            function ItemHand:Toggle(TogInfo, default, callback)
                ...
                ImageLabel.ImageColor3 = _G.Colors
                ...
                ImageButton.ImageColor3 = _G.Colors
            ...
            function ItemHand:Dropdown(droptitle, v, list, callback)
                ...
                DropTextList.TextColor3 = _G.Colors
                ...
                DropStrokeList.Color = _G.Colors
                ...
                DropItemStroke.Color = _G.Colors
                ...
                for i,v in next, list do
                    ...
                    ItemList.BackgroundColor3 = _G.Colors
            ...
            SliderImage.ImageColor3 = _G.Colors
            ...
            SliderSpace.TextColor3 = _G.Colors
            ...
            SliderTitled.TextColor3 = _G.Colors
            ...
            SliderCount.BackgroundColor3 = _G.Colors
            ...
            SliderBox.TextColor3 = _G.Colors
            ...
            SliderInput.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                    dragging = true
                    TweenService:Create(SliderBox, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = _G.Colors}):Play()
                    TweenService:Create(SliderTitled, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = _G.Colors}):Play()
                    TweenService:Create(SliderSpace, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = _G.Colors}):Play()
                    TweenService:Create(SliderImage, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = _G.Colors}):Play()
                    input.Changed:Connect(function()
            ...
            function ItemHand:TextBox(boxtitle, textbox, callback)
                ...
                TextBox.Text = ""
                TextBox.TextColor3 = _G.Colors
                TextBox.TextWrapped = true
                TextBox.TextScaled = false
                TextBox.TextTransparency = 0.5
                TextBox.PlaceholderColor3 = _G.Colors
            ...
            function ItemHand:Bind(textbind, preset, callback)
                ...
                KeyBindButton.TextColor3 = _G.Colors
            ...
            function ItemHand:Label(textlabel)
                ...
                TextButton.TextColor3 = _G.Colors
            ...
            function ItemHand:Line()
                ...
                Frame2.BackgroundColor3 = _G.Colors

...
do
  pcall(function()
    game.CoreGui.FindFirstChild("RaiderUI"):Destroy()
  end)
end

local RaiderLib = Instance.new("ScreenGui")
RaiderLib.Name = "RaiderUI"
RaiderLib.Parent = game.CoreGui
RaiderLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
function lib:Window(text, preset, closebind)
    ...
    Title.Position = UDim2.new(0.0359285731, 0, 0.0564263314, 0)
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Box(text, disapper, callback)

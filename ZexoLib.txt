pcall(function()
  game:GetService("CoreGui"):FindFirstChild("RaiderHub"):Destroy()
end)
...
TextBox.Size = UDim2.new(0, 448.5, 0, -50)
...
Title1.Text =  ""
Title1.TextColor3 = Color3.fromRGB(0, 255, 255)
Title1.TextSize = 20
Title1.TextXAlignment = Enum.TextXAlignment.Left

function Library:Window(v)
  Title1.Text = v
end
...
function Library:CreateTab(name)
    ...
    NameTabButton.ImageColor3 = Color3.fromRGB(0, 255, 255)
    ...
    function TabElements:CreateSection(name)
        ...
        NameSection.ImageColor3 = Color3.fromRGB(20,20,20)
        ...
        SectionBorder.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
        ...
        SectionBorder.ImageColor3 = Color3.fromRGB(0, 255, 255)
        ...
        SectionTitle.BackgroundColor3 = Color3.fromRGB(20,20,20)
        ...
        SectionContent.BorderColor3 = Color3.fromRGB(0, 255, 255)
        ...
        SectionContent.ScrollBarImageColor3 = Color3.fromRGB(0, 255, 255)
        ...
        function SectionElements:Button(name, callback)
            ...
            ButtonRounded.ImageColor3 = Color3.fromRGB(0, 255, 255)
        ...
        function SectionElements:Toggle(name, callback)
            ...
            CheckboxOutline.ImageColor3 = Color3.fromRGB(0, 255, 255)
            ...
            CheckboxTicked.ImageColor3 = Color3.fromRGB(0, 255, 255)
            ...
            local function SetState(state)
                if state then
                    TweenService:Create(Title, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {TextColor3 = Color3.fromRGB(0, 255, 255)}):Play()
        ...
        function SectionElements:Slider(name, minimumvalue, maximumvalue, presetvalue, precisevalue, callback)
            ...
            SliderIndicator.ImageColor3 = Color3.fromRGB(0, 255, 255)
        ...
        function SectionElements:Dropdown(name, options, callback)

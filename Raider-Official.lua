-- RaiderHub • UI Library --
-- Made by SupLuaYT --
-- Do Not Copyright --

pcall(function()
  game.CoreGui:FindFirstChild("RaiderHub"):Destroy()
end)
...
Main.Position = UDim2.new(0.5, 0, 0.5, 0) --UDim2.new(0.590086579, 0, 0.563882053, 0)
...
TextBox.Parent = Main
TextBox.BackgroundColor3 = Library.Theme.BackgroundColor
TextBox.BackgroundTransparency = 0
TextBox.Size = UDim2.new(0, 450, 0, -50)
...
Title12.ZIndex = 2
Title12.Font = Enum.Font.SourceSansBold
Title12.Text =  "X"
...
function Library:CreateTab(name)
    ...
    CloseAllTabs()
    ResetAllTabButtons()
    TweenService:Create(NameTabButton, TweenInfo.new(0.3, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageColor3 = Library.Theme.MainColor}):Play()
    ...
    function TabElements:CreateSection(name)
        ...
        SectionTitle.TextColor3 = Library.Theme.MainColor
        ...
        function SectionElements:Toggle(name, callback)
            ...
            Title.Font = Library.Theme.TextFont
            Title.Text = name
            Title.TextColor3 = Library.Theme.MainColor
            Title.TextSize = 15.000
            ...
            local function SetState(state)
                if state then
                    TweenService:Create(Title, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {TextColor3 = Library.Theme.MainColor}):Play()
        ...
        function SectionElements:Dropdown(name, options, presetoption, callback)
            ...
            TitleToggle.TextColor3 = Library.Theme.MainColor
            ...
            local function ClearAllDropdownItems()
                ...
                TweenService:Create(TitleToggle, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {TextColor3 = Library.Theme.MainColor}):Play()
